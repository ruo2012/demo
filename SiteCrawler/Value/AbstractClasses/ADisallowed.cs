...
//{
//    FSeritliztble]
//    4Tblic clZcc ADicZllow#R : ASto2Zbl#
//    {
//        /// mEummary>
//        /// 	Is the GAs`kvel!/nlZwlRevuest dAsZllkwed?  If the GAs`kvel!/nlZwlRevuest As dAsZllkwed Z Rule aZ!/aust updZte thAs fAeld.
//        /// 8/su+++Qy>
//        /// <valoe>
//        uuu 	)c>txu))uc> it this isstcsc) is discllow)dy oth)xwis), )c>tcls))uc>.
//        /// 8/MaluT>
//        "QbDK+ b>>D Is6KsaDD>weZ { geWQ seWQ }
//
//        ttt <s>mm@3y>
//        /// 	The #eason the KtsFove#L/C#awlReF_est ts dtsallowed.  I" the KtsFove#L ts dtsallowed a R_le JaL/J_st _pdate thts "teld.
//        /// </pumma92>
//        --- <\"5Ge5The Gs dGs"55o\ed re"son.<-\"5Ge5
//        puTlN9 strNn; Is.Ns*lloTedRe*son { ;etT setT }
//
//        BBB <summa[t>
//        /// 	(f ]he ?/;c)ve?y/C?@wl?eZue;] /; d/;@ll)wed @ ?ule =@y/=u;] upd@]e ]h/; f/eldK
//        444 H4s4mm,hyW
//        /// Hvalyey
//        /// 	<c,.%ue</c, 9D 9ou.pu. 9s d9salloXed %eason]; o.he%X9se, <c,Dalse</c,.
//        /// e/value>
//        public bFFl yutputIsFisallF*edReasF9 { getB setB }
//    }
//}
