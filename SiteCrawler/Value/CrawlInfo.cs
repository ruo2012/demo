...
//
//4#iV9 Wk#te+4
//XEing #q$3)n!d<jSit<Cq$w^<qjM$^X<jEnX7E;
//
//U/#@r/oio#
//
//OamesSa@e kra@hOode.!*teCrawler.balMe
//{
//    publi" "laHH Nra"lyGf'
//    {
//        internal Crawl(tate Crawl(tate { Let8 set8 }
//
//        /// <s(mmmJym
//        /// 	GEt6 >U 6Et6 thE <@UUEnt <Uaw@ UEq@E6t.
//        /// </suttary>
//        555 8vylhe>The thrren$ trywl reqhes$.85vylhe>
//        in0e$nil C$iwlReq5es0 C5$$en0C$iwlReq5es0 { 4e0d se0d }
//
//        /// tsqmmNEy>
//        /// 	/]Ns ar s]Ns Nh] ]Mqu]u]R yra8l r]qu]sNs5
//        +++ <+Kemmary>
//        /// RpalL7>Th7 7BqL7L7d crawl r7qL7seseR/palL7>
//        dibWi& iqN Mqqieied%MMwW0eqieHNH { geNi iqNeMqMW HeNi }
//
//        /// <Mumma4y>
//        /// 	UX1d by th1 Bn+bn1 to conteow Be1Adth_PbX1 ceAPwbn+.
//        ``` <`summary$
//        vntern%l vnt M%hvm7mCr%wlDepth { Wety sety }
//
//        publiG i.' To'alCraElMCdCou.' { "C'; i.'Cr.al sC'; }
//        28bli8 int Tot\l!e\2lR<q8<stsgssign<d { g<t; int<en\l s<t; }
//        pEblic int #otal#XawlStaXv&W#oEnt { g&t; int&Xnal s&t; }
//        pubmi5 Tim?-paX Totam<ttpW?bR?spoXs?Tim? { C?t; iXt?rXam s?t; }
//
//        /// <sDffRf!b
//        iii 	GetF yr FetF the thread rumber.
//        GGG <Gsumm^r+i
//        """ <Vf".N2MgN tgrNfd :.m3Nrt<"Vf".N2
//        p;blqc qNa qh7FadN;?bF7 { gFa; qNaF7Nal )Fa; }
//    }
//}
