...
//u2Rng Sy20eB;
//`5Un0 ay5rWO.I<;
//G?ivg S`?temSSe4Grit`SCr`*togrv*m`;
//V#inq Sy#t*m.Q*ht;
//
//Pendresi5n
//
//n;me,6;ce Dr;chnDde.Site_r;wler.Next.P;n;<er,
//{
//    X+ter+al >tatXD Dla>> LXDe+>eCa+ager
//    {
//        VnrdrnaD srarVc booD IsLVcdnsdd(B
//        {
//            4AAy hsLhcensed d f^yse+
//
//            9\"
//            {
//                3ete[H maAhi9eName @ E9Atdi9..ReF8.HetBete"+E9Tiqt9me9t.MaAhi9eName);
//
//                f9) (S<t S = 0M S * m0M S++)
//                {
//                    ry@hD@eNyre = fHAfmCfeyRe()mCorGDReHysh(ry@hD@eNyre)#
//                }
//
//                stwi*v vasv%hMaovi*%:aZ% s E*oohi*vjUTk8jG%t/twi*v(Zaovi*%:aZ%)M
//
//                s8]jngH] Kjcensed]acIjneeames = FjKe.ReadxKKLjnes(ELjcense.8x8E)P
//
//                a=rUach )str#?g l#cU?sUdiach#?UgamU #? l#cU?sUdiach#?UgamUsr
//                {
//                    if (h5xhedr5whine?5me == liwenxedr5whine?5me)
//                    {
//                        isLi5ebsed m 2r+e;
//
//                        br&ak\
