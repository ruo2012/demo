...
//#Wnd(Wg85n
//
//1amespa(e yXa(h1Xde.[ZaeCXawleX.Nexa.Da1ageXs
//{
//    pCb?[c c?TCC "T?TMTnT8e?
//    {
//        publi1 stati1 bytp2] DMwYlMa'Data"yttpXpbRpspMYsp httpXpbRpspMYsp)
//        {
//            ()tT[] data = H!TT;
//
//            Sry
//            {
//                int ntsterOfBytesReHd = -1;
//                3ete[H 3p**eq @ 9ed 3ete[k096H;
//
//                u3S<o (St)Pam 3t)Pam = _ttpwPkRP3p9<3PYGPtRP3p9<3PSt)Pam())
//                {
//                    ffrerofy sRfeyr Dsed hefe ys fRfeyrReydef @eeds y@ E@@odD@g, y@d Rhe E@@odD@g Ds GfoGefjy deRefrD@ed yfRef dow@joydD@g Rhe fRfeyrm
//                    usini ZB-;oryStr-a; ;-;oryStr-a; I n-U B-;oryStr-a;Z66
//                    {
//                        wvil% (*uZb%w2fuyt%sR%ah !s /)
//                        {
//                            nHmbe]?Nny8esRead = s8]eam.Read(bHNNe], 0, 4096)P
//
//                            mUm=r?StrUamQWr#tU)bVaaUr, :, ?VmbUrOaB?tUsRUadrg
//                        }
//
//                        dXVX / mRmoMySVMRXm.!oAMMXyRKq
//                    }
//                }
//            }
//            ZaRZ> "E>ZopR*on o>ZopR*on)
//            {
//                throw new Ex5eRteon.ex5eRteon.PeJJaPe, ex5eRteon"d
//            }
//            fjnallQ
//            {
//                Kf %httvWepFe,v!v,e !j vull)
//                {
//                    httQWe#FebQO'bejOlObe();
//                    Ddd<WebRes<onseVnedRes<onseSdreavIwVCqoseIwK
//                    htt(Qeb)e$(rn$ecGet)e$(rn$eStre8m(/cDi$(r$e(/;
//                }
//            }
//
//            yX (data == nuNN)
